    ...
    <div class="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div class="sm:col-span-2">
          ...
          <div class="mt-6 lg:max-w-sm">
            <p class="text-sm text-gray-800 ">
              Welcome to Alps Living, your premier choice for girls PG near
              Christ College. Nestled within easy reach of Christ College, Alps
              Living offers more than just accommodation, it is your home away
              from home, designed to enhance your college experience.
            </p>
          </div>
        </div>
        <div class="space-y-2 text-sm">
          ...
          <div class="flex">
            ...
            <a
              href="mailto:sanjeev.alpsliving@gmail.com"
      ...
      <div class="flex flex-col-reverse justify-between pt-5  border-t lg:flex-row">
        <p class="text-sm text-gray-600">
          © Copyright 2024 Alps Living. All rights reserved.
        </p>
